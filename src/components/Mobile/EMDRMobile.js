          ...
          <div className="emdr-mob-text-cont">
            <Fade duration={2000} delay={750}>
              <MobText style={{ fontSize: "1.25em" }}>
                ...
                In my opinion, it really is. You may have not ever heard of
                EMDR, but your body could probably benefit from it.{" "}
              </MobText>
            </Fade>
            <Fade duration={2000}>
              <div className="mob-one-emdr">
                <MobText>
                  I'm going to explain what EMDR is in my own voice, and then
                  provide you with some resources so you can learn more.
                </MobText>
              </div>
            </Fade>
            <Fade duration={2000}>
              <div className="mob-one-emdr">
                <MobText>
                  ...
                  <i>literally</i> gets trapped in our bodies. Ever wonder why
                  all of a sudden you smell your ex-from-10,000-years-ago's
            ...
            <Fade duration={2000}>
              <MobText>
                ...
                <b className="landing-m-b-two">triggered.</b> The sound of
                someone dropping a dinner glass can trigger you into feeling you
                are about to get side swiped by some huge metal object.
                Horrifying!
              </MobText>
            </Fade>
          </div>
          <Fade duration={2000}>
            <div style={{ textAlign: "center" }} className="mob-two-emdr">
              <MobText>
                ...
                eventually the car accident that your body remembers{" "}
                <b className="landing-m-b-two">
          ...
          <Fade duration={2000}>
            <div style={{ textAlign: "center" }}>
              <MobText>
                ...
                side to side, or using bilateral stimulation significantly
                reduced negative thoughts and traumatic memories. EMDR was born,
                and this full blown
                <b className="landing-m-b-two">
          ...
          <Fade duration={2000}>
            <div style={{ textAlign: "center" }}>
              <MobText>
                ...
                accepting patients on a case by case basis. I am available to
